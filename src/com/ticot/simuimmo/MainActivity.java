...
public class MainActivity extends Activity {
	 ...
	 * 
	 * @param view
	 *            representing the object that run the method. (not used in that case)
	 * 
	 * @since 1.0
	 */
	 ...
	 * </ul>
	 * To switch from one to another, there is a CheckBox. The value of this checkBox informs whether the application must compute the
	 * value and display it or take the value from the field as an input.
	 * </p>
	 * 
	...
	private boolean[] backupRealValueState() {
		...
		final boolean[] table = { ((CheckBox) findViewById(R.id.ReelNetVendeur)).isChecked(),
	 ...
	 * 
	 * @param table
	 *            a boolean table aggregating the states of the CheckBoxes.
	 * 
	...
	/**
	 * Get the user's input values from the EditText and CheckBox. Values are set in an Input class, used afterward.
	 * 
	 * @see Input
	 * 
	 * @since 1.0
	...
	private void getFormInput() {
		...
		Inputs.tauxCredit = Double.valueOf(checkFieldValue((EditText) findViewById(R.id.valueReelTauxCredit),
				String.valueOf(Settings.taux25ans)));
		Inputs.tauxAssuranceCredit = Double.valueOf(checkFieldValue((EditText) findViewById(R.id.valueReelTauxAssurance),
	 ...
	 * 
	 * @param view
	 *            representing the EditText object of the field to get the value from.
	 * @param defaultValue
	 *            the default value to set in cas the field is not correct and not mandatory.
	 * 
	...
	private void fillComputedValues(Acquisition a, Gestion g) {
		...
		((EditText) findViewById(R.id.valueReelPrixFAI)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getPrixFAI())));
		((EditText) findViewById(R.id.valueReelNetVendeur)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getNetVendeur())));
		((EditText) findViewById(R.id.valueReelFraisAgence)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getFraisAgence())));
		((EditText) findViewById(R.id.valueReelFraisNotaire)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getFraisNotaire())));
		((EditText) findViewById(R.id.valueTravaux)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition()).getTravaux())));
		((EditText) findViewById(R.id.valueAmenagement)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getAmenagement())));
		((EditText) findViewById(R.id.valueReelHonoraireConseil)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getHonoraireConseil())));
		((EditText) findViewById(R.id.valueAutresFrais)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getAutresFrais())));
		((EditText) findViewById(R.id.valueApport)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition()).getApport())));
		
		//Format user's inputs for Emprunt
		((EditText) findViewById(R.id.valueReelCapitalEmprunte)).setText(String.valueOf(formatEur.format((a.getEmprunt())
				.getCapitalEmprunte())));
		((EditText) findViewById(R.id.valueReelTauxCredit))
				.setText(String.valueOf(formatPer.format((a.getEmprunt()).getTauxCredit())));
		((EditText) findViewById(R.id.valueReelTauxAssurance)).setText(String.valueOf(formatPer.format((a.getEmprunt())
				.getTauxAssuranceCredit())));
		
		//Fill computed values for FraisAcquisition
		((TextView) findViewById(R.id.valuePrixFAI)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition()).getPrixFAI())));
		((TextView) findViewById(R.id.valueNetVendeur)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getNetVendeur())));
		((TextView) findViewById(R.id.valueFraisAgence)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getFraisAgence())));
		((TextView) findViewById(R.id.valueFraisNotaire)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getFraisNotaire())));
		((TextView) findViewById(R.id.valueHonoraireConseil)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getHonoraireConseil())));
		((TextView) findViewById(R.id.valueCoutTotal)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getCoutTotal())));
		((TextView) findViewById(R.id.valueSequestre)).setText(String.valueOf(formatEur.format((a.getFraisAcquisition())
				.getSequestre())));
		
		//Fill computed values for Emprunt
		((TextView) findViewById(R.id.valueCapitalEmprunte)).setText(String.valueOf(formatEur.format((a.getEmprunt())
				.getCapitalEmprunte())));
		((TextView) findViewById(R.id.valueNbMensualite)).setText(String.valueOf((a.getEmprunt()).getNbMensualiteCredit()));
		((TextView) findViewById(R.id.valueTauxCredit)).setText(String.valueOf(formatPer.format((a.getEmprunt()).getTauxCredit())));
		((TextView) findViewById(R.id.valueTauxAssurance)).setText(String.valueOf(formatPer.format((a.getEmprunt())
				.getTauxAssuranceCredit())));
		((TextView) findViewById(R.id.valueMensualite))
				.setText(String.valueOf(formatEur.format((a.getEmprunt()).getMensualiteCredit())));
		((TextView) findViewById(R.id.valueTauxEndettement)).setText(String.valueOf(formatPer.format((a.getEmprunt())
				.getTauxEndettement())));
	}
	 ...
	 * 
	 * @param view
	 *            representing the View object that runs the method.
	 * 
	 * @since 1.0
	 */
