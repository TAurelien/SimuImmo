 ...
 * <p>
 * The class Emprunt is part of the class Acquisition. </br>The additional costs of
 * acquisition are represented by the class FraisAcquisition.
 * </p>
 * <p>
...
public class Emprunt {
	 ...
	 * Constructor of Emprunt.
	 * <p>
	 * Constructor with the variable dureeCredit.
	 * </p>
	 * 
	 * @param dureeCredit
	 * 
	 ...
	 * 
	 * @return a double representing the real credit insurance rate
	 * (tauxAssuranceCreditReel).
	 * @deprecated
	 */
	@Deprecated
	...
	public String toString() {
		...
		return "=== Emprunt ===" + "\nLa duree du credit est de " + dureeCredit
				...
				+ "\nLe taux d'assurance est de " + tauxAssuranceCredit /*
																		 * +
																		 * "\nLe taux d'endettement est de NA"
																		 * +
																		 * tauxEndettement
																		 */;
	}
