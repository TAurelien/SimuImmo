...
/**
 * The class FraisLocationAnnuelle represents the details of the annual rental expenses for a real estate.
 * <p>The class FraisLocationAnnuelle is part of the class Gestion.</p> 
...
public class FraisLocationAnnuelle {
	 ...
	 * @return a double representing the rental manageemnt expenses (fraisGestionLocation).
	 */
	 ...
	 * @return a double representing the real rental management expenses (fraisGestionLocationReel).
	 * @deprecated
	 */
	 ...
	 * @return a boolean representing the decision of managing the rental through estate agency(gestionParAgence).
	 */
	 ...
	 * @param fraisGestionLocationReel the double of the real rental management expenses to set.
	 * @deprecated
	 */
