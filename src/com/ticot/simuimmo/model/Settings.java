 ...
 * <p>
 * All computation are done based on value from this Settings class.</br> This is not the
 * SharedPreferences, even though all values come from the SharedPreferences.
 * </p>
 * <p>
 * The variables don't represent the user's inputs, there is a dedicated class Inputs for
 * them.
 * </p>
 * 
 * @see Inputs
